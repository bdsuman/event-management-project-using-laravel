	...
	<div class="container">
		<div class="row listrecent listrelated">
			...
			<div class="col-md-4">
				<div class="card">
					<a href="post.html">
					<img class="img-fluid img-thumb" src="{{ asset('frontend/img/demopic/9.jpg')}}" alt="">
					</a>
			...
			<div class="col-md-4">
				<div class="card">
					<a href="post.html">
					<img class="img-fluid img-thumb" src="{{ asset('frontend/img/demopic/8.jpg')}}" alt="">
					</a>
					<div class="card-block">
			...
			<div class="col-md-4">
				<div class="card">
					<a href="post.html">
					<img class="img-fluid img-thumb" src="{{ asset('frontend/img/demopic/7.jpg')}}" alt="">
					</a>
					<div class="card-block">
